...
<html lang="ko">
	...
	<body>
		...
		<div id="wrap">
		    ...
		    <div id="content" class="web-content service-type01 service-typeA">
		        <div class="container" id="printArea">
		            <div class="service-top">
		            	<div class="service-typeA--content">
		            		<div class="service-top__title">
		            			<span>${util:toHtmlTagBlank(sVo.svcNm)}</span>
				                <!-- [D] 라인형 : serivce-category serivce-category--line , 색상형 : serivce-category serivce-category--fill , 아이콘형 serivce-category serivce-category--icon, 색색별 아이콘형 : serivce-category--icon2 -->
				                <div class="serivce-category serivce-category--line">
		                ...
		                <div class="service-typeA__box">
		                    <div class="service-typeA__txt">
		                        <strong class="service-typeA__title">신청수단</strong>
		                        <c:if test="${sVo.reqstMeanCdArr != ''}" >
									<span class="service-typeA__text">
										<c:choose>
		                    ...
		                    <c:choose>
                               	<c:when test="${fn:indexOf(sVo.reqstMeanCdArr,'BF0101') > -1}">
						    		...
						    		<c:if test="${sVo.onlnReqstSiteUrl ne null && sVo.onlnReqstSiteUrl ne '' && btnEprss ne 'N' }">
		                    			<a href="${util:toHtmlTagBlank(sVo.onlnReqstSiteUrl)}" id="directUrl" class="service-typeA__link">온라인신청 바로가기</a>
		                    		</c:if>
                               	</c:when>
                               	<c:when test="${fn:indexOf(sVo.reqstMeanCdArr,'BF0101') < 0 and fn:indexOf(sVo.reqstMeanCdArr,'BF0102') > -1 && btnEprss ne 'N'}">                              		
                               		<a href="#" class="service-typeA__link" data-element="modal__open" data-target="#lypop02">타사이트 바로가기</a>
                               	</c:when>
								<c:otherwise>
                               	</c:otherwise>
							</c:choose>
		            ...
		            <div class="service-wrap">
		                ...
		                <div class="service-wrap__right">
							...
							<c:if test="${sVo.slctnStdr ne null && sVo.slctnStdr ne ''}">
								<div class="service-wrap__title-wrap">
			                        <div class="service-wrap__title">
			                            선정기준
			                        </div>
			                    </div>
				                <div class="service-wrap__text" data-element="toggle-list">
		                        	<div class="service-wrap__inner">
		            ...
		            <div class="service-wrap">
		                ...
		                <div class="service-wrap__right">
							...
							<c:if test="${sVo.rcvOrgNm ne null && sVo.rcvOrgNm ne ''}">
								<div class="service-wrap__title-wrap">
		                    ...
		                    <div class="service-wrap__text">
		                        <div class="service-wrap__inner">
		                        	...
		                        	<%-- <c:if test="${sVo.onlnReqstSiteUrl ne null}" >
		                        		<br>웹사이트 : <url id="webUrl">
		                        	</c:if> --%>
		                        </div>
							</div>
							<div class="service-wrap__title-wrap">
		...
		$(document).ready(function(){
			...
			if(btnEprss == "N"){
				...
				if(url.indexOf(",nbsp;") > 0){
					...
					// document.getElementById("webUrl").innerHTML = txt;
