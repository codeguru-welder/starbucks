...
<html lang="ko">
	...
	<body>
		...
		<div id="wrap">
		    ...
		    <div id="content" class="web-content service-type03 service-typeC">
		        <div class="container" id="printArea">
		            <!-- [D] background-color 변경 부분 -->
					<div class="service-top" style="background-color:${fVo.upendBgColorCls}">
					
	                	<div class="service-typeC--img">
		                    <img src="/rcvfvrSvc/images/C/detail/${fVo.upendBgImgTyCls}" alt="서비스상세 C타입 비주얼 배경이미지">
		                </div>
                		<div class="service-typeC--content">
			                <div class="service-top__title">${util:toHtmlTagBlank(sVo.svcNm)}</div>
			                <p class="service-top__text">${util:toHtmlTagBlank(sVo.svcPpo)}</p>
			                <%-- <p class="service-top__sub-text">${util:toHtmlTagBlank(sVo.reqstTmlmtEtc)}</p> --%>
			                <div class="service-bottom">
								...
								<div class="service-typeC__box">
		                            <div class="service-typeC__txt">
		                                <strong class="service-typeC__title">신청수단</strong>
		                                <span class="service-typeC__text">
			                                <c:choose>
		                            ...
		                            <c:choose>
	                                	<c:when test="${fn:indexOf(sVo.reqstMeanCdArr,'BF0101') > -1}">		                                		
								    		...
								    		<c:if test="${sVo.onlnReqstSiteUrl ne null && sVo.onlnReqstSiteUrl ne '' && btnEprss ne 'N'}">
				                    			<a href="${util:toHtmlTagBlank(sVo.onlnReqstSiteUrl)}" id="directUrl" class="service-typeC__link">온라인신청 바로가기</a>
				                    		</c:if>
	                                	</c:when>
	                                	<c:when test="${fn:indexOf(sVo.reqstMeanCdArr,'BF0101') < 0 and fn:indexOf(sVo.reqstMeanCdArr,'BF0102') > -1 && btnEprss ne 'N'}">		                                		
	                                		<a href="#" class="service-typeC__link" data-element="modal__open" data-target="#lypop02">타사이트 바로가기</a>
	                                	</c:when>
										<c:otherwise>
	                                	</c:otherwise>
									</c:choose>
		                ...
		                <div class="service-wrap__right">
		                    ...
		                    <c:if test="${sVo.slctnStdr ne null && sVo.slctnStdr ne '' }">
			                    <div class="service-wrap__title-wrap">
			                        <div class="service-wrap__title"><!-- toggle 버튼이 붙는 타이틀의 경우 service-wrap__title--toggle 클래스 필요 -->
										선정기준
		            ...
		            <div class="service-wrap">
		                ...
		                <div class="service-wrap__right">
		                    ...
		                    <c:if test="${sVo.posesPapers ne null && sVo.posesPapers ne ''}">
			                    ...
			                    <div class="service-wrap__text"">
			                    	<div class="service-wrap__inner">
			                        	<p>${util:toHtmlTagBlank(sVo.posesPapers)}</p>
			                        </div>
			                    </div>
							</c:if>
		                </div>
