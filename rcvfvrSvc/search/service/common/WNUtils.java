...
public class WNUtils {
    ...
    public static String parseDate(String input, String inFormat, String outFormat) {
        ...
        try {
            ...
            CommonLoggerFactory.APP_LOGGER.error("ParseException 발생");
        }
    ...
    public static String encoding(String str, String oriEncode, String newEncode) {
        ...
        if(str.length() > 0) {
            try {
                ...
                CommonLoggerFactory.APP_LOGGER.error("UnsupportedEncodingException 발생");
            }
        }
        return str;
    }
    ...
    public static String validate(String str) {
        ...
        for(int i=0; i < str.length(); i++) {
            ...
            if(Character.isLetterOrDigit(ch)) {
                CommonLoggerFactory.APP_LOGGER.debug("[letterOrDigit]");
            } else {
                if(Character.isWhitespace(ch)) {
                    CommonLoggerFactory.APP_LOGGER.debug("[String is whiteSpace]");
                } else {
